-- HUB CAFE System - Supabase Database Schema (Simplified)
...
-- Note: Row Level Security (RLS) policies are disabled initially
-- You can enable them later after initial setup is complete
